...
namespace CentralitaHerencia
{
    public class Centralita
    {
        ...
        public static bool operator == (Centralita c, Llamada llamada)
        {
            ...
            foreach (Llamada llamadaFor in c.Llamadas)
            {
        ...
        public static Centralita operator + (Centralita c, Llamada llamada)
        {
            ...
            {
                throw new CentralitaException("La llamada está registrada en el sist.", "Centralita", "Agregar llamada a la centralita\n");
            }
            return c;
        }
    }
